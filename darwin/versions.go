...
var (
	...
	SnowLeopard  = Version{value: "snow-leopard", version: "10.6"}
	...
	Sierra       = Version{value: "sierra", version: "10.12"}
	HighSierra   = Version{value: "high-sierra", version: "10.13"}
	...
	Sonoma       = Version{value: "sonoma", version: "14"}
	Sequoia      = Version{value: "sequoia", version: "15"}
	Tahoe        = Version{value: "tahoe", version: "26"}
)

// ShowLeopard, Serra, HighSerra are deprecated aliases
// Use SnowLeopard, Sierra, HighSierra instead
var (
	ShowLeopard = SnowLeopard
	Serra       = Sierra
	HighSerra   = HighSierra
)
